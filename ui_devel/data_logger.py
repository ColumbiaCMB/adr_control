...
class DataFile():
    def __init__(self,base_dir='/home/adclocal/data/garbage_cooldown_logs',suffix=''):
        ...
        self.bridge_range=self.nc.createVariable('bridge_range',np.uint8,dimensions=('time',))
        self.bridge_excitation=self.nc.createVariable('bridge_excitation',np.float32,dimensions=('time',))
        self.bridge_excitation_on=self.nc.createVariable('bridge_excitation_on',np.uint8,dimensions=('time',))
        self.bridge_excitation_mode=self.nc.createVariable('bridge_excitation_mode',np.uint8,dimensions=('time',))
        ...
        self.bridge_output_temperature=self.nc.createVariable('bridge_output_temperature',np.uint8,dimensions=('time',))
        ...
        self.bridge_output_model=self.nc.createVariable('bridge_output_mode',np.uint8,dimensions=('time',))
        ...
        self.pid_propor_on=self.nc.createVariable('pid_propor_on',np.uint8,dimensions=('time',))
        self.pid_integral_on=self.nc.createVariable('pid_integral_on',np.uint8,dimensions=('time',))
        self.pid_deriv_on=self.nc.createVariable('pid_deriv_on',np.uint8,dimensions=('time',))
        self.pid_offset_on=self.nc.createVariable('pid_offset_on',np.uint8,dimensions=('time',))
        self.pid_propor_gain=self.nc.createVariable('pid_propor_gain',np.float32,dimensions=('time',))
        self.pid_polarity=self.nc.createVariable('pid_polarity',np.uint8,dimensions=('time',))
        ...
        self.pid_ramp_on=self.nc.createVariable('pid_ramp_on',np.uint8,dimensions=('time',))
        self.pid_ramp_status=self.nc.createVariable('pid_ramp_status',np.uint8,dimensions=('time',))
        self.pid_manual_out=self.nc.createVariable('pid_manual_out',np.float32,dimensions=('time',))
        self.pid_manual_status=self.nc.createVariable('pid_manual_status',np.uint8,dimensions=('time',))
        ...
        self.mx_channel=self.nc.createVariable('mx_channel',np.uint8,dimensions=('time',))
